...
VC = VC %>% select(X_id, Date, covid19_cases_unvac, covid19_cases_partial_vac, covid19_cases_full_vac)
...
As 0.01 is not within the 95% confidence interval, we reject the null hypothesis that the COVID-19 mortality rate is 1.0%. This supports our altenative hypothesis that deaths were initially incorrectly attributed to COVID-19. 
